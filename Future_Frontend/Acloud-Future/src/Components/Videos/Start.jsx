        ...
        <div className="row">
          ...
          <div className="col-md-8 m-auto">
            <div className="container my-3">
              ...
              <p align="justify">Great, everything is ready for you to record your interaction.</p>
              <p align="justify">After clicking the "Start" button below, the camera and microphone will turn on & you'll see questions throughout the interaction that you'll need to answer.</p>
